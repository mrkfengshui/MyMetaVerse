...
const PalaceGrid = ({ 
    ...
    return (
        <div onClick={onClick} style={{ border: `1px solid ${THEME.border}`, position: 'relative', backgroundColor: currentBgColor, height: '100%', minHeight: '140px', overflow: 'hidden', padding: '2px', cursor: 'pointer' }}>
            ...
            <div style={{ position: 'absolute', bottom: 5, left: 2, display: 'flex', flexDirection: 'row', alignItems: 'flex-end', maxWidth: '30px', zIndex: 2 }}>
            ...
            <div style={{ position: 'absolute', bottom: 5, right: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1px', zIndex: 2 }}>
